...
SELECT * FROM VJEZBE.KLIJENT;
INSERT INTO VJEZBE.ALARM (OPIS, KLIJENT_ID, VRIJEME, AKTIVAN) VALUES('Istek roka', 2, {ts '2017-01-01 15:05:00.00'}, 'TRUE');
UPDATE VJEZBE.ALARM SET VRIJEME = {ts '2017-08-25 12:57:00.00'} WHERE ID = 2;

SELECT * FROM VJEZBE.ALARM WHERE TIMESTAMPDIFF('SECOND', NOW(), VRIJEME) <= 60 ORDER BY VRIJEME ASC;
